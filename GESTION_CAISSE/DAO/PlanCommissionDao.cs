...
{
    class PlanCommissionDao
    {
        public static PlanCommission getOnePlanCommission(long id)
        {
            NpgsqlConnection con = Connexion.Connection();
            try
            {
                String search = "select * from yvs_com_plan_commission where id = " + id + "";
        ...
        private static long getCurrent()
        {
            ...
            try
            {
                String search = "select id from yvs_com_plan_commission order by id desc limit 1";
                NpgsqlCommand Lcmd = new NpgsqlCommand(search, con);
                NpgsqlDataReader lect = Lcmd.ExecuteReader();
                long id = 0;
                if (lect.HasRows)
        ...
        public static PlanCommission getAjoutPlanCommission(PlanCommission a)
        {
            NpgsqlConnection con = Connexion.Connection();
            try
            {
        ...
        public static bool getUpdatePlanCommission(PlanCommission a)
        {
            NpgsqlConnection con = Connexion.Connection();
            try
            {
        ...
        public static bool getDeletePlanCommission(long id)
        {
            NpgsqlConnection con = Connexion.Connection();
            try
            {
